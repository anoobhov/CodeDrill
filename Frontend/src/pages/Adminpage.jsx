...
const problemSchema = z.object({
    ...
    tags:z.enum(['array',"dp",'linkedlist']),
    visibleTestCases:z.array(
        z.object({
            input:z.string().min(1,"Input is missing"),
            output:z.string().min(1,"output is missing"),
            explanation:z.string().min(1,'Explanation is required')
        })
    ).min(1,'atleast 1 visible case is required'),
...
function AdminPanel() {
  ...
  const onSubmit = async (data) => {
    try {
      await axiosClient.post('/problem/problemcreate') 
