                    ...
                    {submitResult.accepted ? (
                      <div>
                        ...
                        <div className="mt-4 space-y-2 bg-black text-white rounded-2xl p-3">
                          <p className='flex items-center gap-1'><TestTubeDiagonal className={`${submitResult.success ? 'text-green-400' : 'text-red-500'}`}/>Test Cases Passed: {submitResult.passedTestCases}/{submitResult.totalTestCases}</p>
                          <hr className={`${submitResult.success ? 'text-green-400' : 'text-red-500'}`}></hr>
